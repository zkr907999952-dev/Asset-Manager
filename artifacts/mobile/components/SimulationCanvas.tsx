      ...
      >
        ...
        {isInternal && (
          <G clipPath="url(#cavityClip)">
            {/* Intestine anatomical background image — female anatomy, 3:4 portrait, slice to fill cavity */}
            <SvgImage
              href={INTESTINES_REF}
              x={CAVITY_CX - CAVITY_RX * 1.08} y={CAVITY_CY - CAVITY_RY * 1.12}
              width={CAVITY_RX * 1.08 * 2} height={CAVITY_RY * 1.12 * 2}
              preserveAspectRatio="xMidYMid slice" opacity={0.48} />
