...
const styles = StyleSheet.create({
  ...
  titleLine: {
    ...
    marginTop: 10,
    marginBottom: 7,
    boxShadow: '0px 0px 6px rgba(255,100,180,0.7)',
  } as any,
  titleSub: {
    fontSize: 11,
    ...
    letterSpacing: 3,
    textShadow: '0px 0px 8px rgba(255,160,210,0.8), 0px 1px 4px rgba(0,0,0,0.95)',
  } as any,
  ...
  menuBtnLabel: {
    ...
    fontSize: 15,
    letterSpacing: 4,
    color: 'rgba(255,215,235,0.92)',
    textAlign: 'right',
    textShadow: '0px 0px 8px rgba(255,150,210,0.55), 0px 1px 3px rgba(0,0,0,0.98), 0px 0px 1px rgba(0,0,0,1)',
  } as any,
  menuBtnHighlight: {
    color: '#ffaadd',
    textShadow: '0px 0px 10px rgba(255,100,200,0.95), 0px 0px 24px rgba(255,50,160,0.7), 0px 2px 6px rgba(0,0,0,0.98)',
  } as any,
  menuBtnHovered: {
    color: '#ffffff',
    textShadow: '0px 0px 8px rgba(255,255,255,0.95), 0px 0px 20px rgba(255,160,230,0.8), 0px 0px 38px rgba(255,80,200,0.55), 0px 2px 6px rgba(0,0,0,0.98)',
  } as any,
  btnUnderline: {
    height: 1,
    width: 0,
